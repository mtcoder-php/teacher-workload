...
class RolePermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissions = [
            ...
            // Semestrlar
            ['name' => 'semesters.view', 'display_name' => 'Semestrlarni ko\'rish', 'group' => 'semesters'],
            ['name' => 'semesters.create', 'display_name' => 'Semestr qo\'shish', 'group' => 'semesters'],
            ['name' => 'semesters.edit', 'display_name' => 'Semestrni tahrirlash', 'group' => 'semesters'],
            ['name' => 'semesters.delete', 'display_name' => 'Semestrni o\'chirish', 'group' => 'semesters'],
