<template>
    <AuthenticatedLayout>
        <template #header>Guruhni tahrirlash</template>
...
const props = defineProps({ group: Object, directions: Array })
...
const form = useForm({
    ...
    education_language: props.group.education_language || 'uzbek',
...
const submit = () => form.put(`/groups/${props.group.id}`, { preserveScroll: true })
</script>
