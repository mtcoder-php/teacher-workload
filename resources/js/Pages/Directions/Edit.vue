<template>
    <Head :title="`${direction.name} - Tahrirlash`" />
        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                    <h3 class="text-lg font-semibold text-gray-900">{{ direction.name }}</h3>
                    <p class="text-sm text-gray-600 mt-1">Yo'nalish ma'lumotlarini o'zgartirish</p>
                </div>
...
const submit = () => {
    form.put(`/directions/${props.direction.id}`, {
        preserveScroll: true,
    });
};
</script>
