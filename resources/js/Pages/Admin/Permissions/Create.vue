        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-sm">
                <div class="p-6 border-b border-gray-200">
                    ...
                    <p class="text-sm text-gray-500 mt-1">Yangi ruxsat yaratish uchun forma</p>
                </div>
                ...
                <form @submit.prevent="submit" class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500">
                            Format: <code class="bg-gray-100 px-1 rounded">guruh.amal</code> (masalan: users.view, teachers.create)
                        </p>
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        <div class="flex items-start">
                            ...
                            <div class="text-sm text-blue-800">
                                <p class="font-medium mb-2">Ruxsat nomlari namunalari:</p>
                                <ul class="space-y-1 text-blue-700 font-mono text-xs">
                                    <li>• <span class="bg-blue-100 px-1 rounded">users.view</span> - Foydalanuvchilarni ko'rish</li>
                                    <li>• <span class="bg-blue-100 px-1 rounded">users.create</span> - Foydalanuvchi yaratish</li>
                                    <li>• <span class="bg-blue-100 px-1 rounded">users.edit</span> - Foydalanuvchini tahrirlash</li>
                                    <li>• <span class="bg-blue-100 px-1 rounded">users.delete</span> - Foydalanuvchini o'chirish</li>
                                    <li>• <span class="bg-blue-100 px-1 rounded">workloads.approve</span> - Yuklamani tasdiqlash</li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
const generateSlug = () => {
    if (!form.name) {
        const displayName = form.display_name.toLowerCase();
        
        // Agar "ko'rish", "yaratish" kabi so'zlar bo'lsa
        const actionMap = {
            'ko\'rish': 'view',
            'korish': 'view',
            'yaratish': 'create',
        ...
        // Action mapping
        for (const [uz, en] of Object.entries(actionMap)) {
            slug = slug.replace(uz, en);
        }
