<template>
    <AuthenticatedLayout>
        <template #header>Fanni tahrirlash</template>
            ...
            <div class="bg-white rounded-lg shadow-sm">
                <div class="p-6 border-b border-gray-200 flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1">{{ subject.name }}</p>
                    </div>
...
const props = defineProps({
    subject: Object, departments: Array, directions: Array, courseLevels: Array,
    subjectTypes: Array, educationForms: Array, controlTypes: Array,
})

const form = useForm({
    name: props.subject.name, code: props.subject.code,
    department_id: props.subject.department_id, direction_id: props.subject.direction_id,
    course_level: props.subject.course_level, subject_type: props.subject.subject_type,
    education_form: props.subject.education_form, credit_hours: props.subject.credit_hours,
    semester_1_lecture: props.subject.semester_1_lecture, semester_1_practical: props.subject.semester_1_practical,
    semester_1_laboratory: props.subject.semester_1_laboratory, semester_1_seminar: props.subject.semester_1_seminar,
    semester_1_practice: props.subject.semester_1_practice, semester_1_exam: props.subject.semester_1_exam,
    semester_1_test: props.subject.semester_1_test, semester_1_control: props.subject.semester_1_control,
    semester_2_lecture: props.subject.semester_2_lecture, semester_2_practical: props.subject.semester_2_practical,
    semester_2_laboratory: props.subject.semester_2_laboratory, semester_2_seminar: props.subject.semester_2_seminar,
    semester_2_practice: props.subject.semester_2_practice, semester_2_exam: props.subject.semester_2_exam,
    semester_2_test: props.subject.semester_2_test, semester_2_control: props.subject.semester_2_control,
    coursework_hours: props.subject.coursework_hours, diploma_hours: props.subject.diploma_hours,
    consultation_hours: props.subject.consultation_hours, description: props.subject.description || '',
    is_active: props.subject.is_active, can_be_potok: props.subject.can_be_potok,
...
const submit = () => form.put(`/subjects/${props.subject.id}`, { preserveScroll: true })
</script>
