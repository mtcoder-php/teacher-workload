<template>
    <Head title="Fakultetni tahrirlash"/>
    <AuthenticatedLayout>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                    <div class="flex items-center justify-between">
                        <h2 class="text-xl font-semibold text-gray-800">Fakultet ma'lumotlari</h2>
                        <Link
                ...
                <form @submit.prevent="submit" class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        >
                            <option :value="null">Dekan tanlang</option>
                        ...
                        <p class="mt-1 text-xs text-gray-500">
                            Dekan ma'lumotlarini o'zgartirish uchun Foydalanuvchilar bo'limiga o'ting
                        </p>
                    </div>
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-blue-700">
                            Fakultet ma'lumotlarini o'zgartirayotganingizda ehtiyot bo'ling. 
...
// ✅ TO'G'RI: Faqat faculty ma'lumotlari
const form = useForm({
...
const submit = () => {
    form.put(`/faculties/${props.faculty.id}`, {
        preserveScroll: true,
    });
};
</script>